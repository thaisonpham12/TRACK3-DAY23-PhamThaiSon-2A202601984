...
class AgentState(TypedDict, total=False):
    ...
    - Scalar / current-value fields (overwritten on update):
      thread_id, scenario_id, query, route, risk_level, attempt, max_attempts,
      final_answer, evaluation_result, pending_question, proposed_action, approval
    - Append-only fields (merged via operator.add reducer):
